	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					<label for="disponibilidad" class="col-sm-2 control-label">¿Esta Disponible?</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="disponibilidad" name="disponibilidad" placeholder="S/N"value="<?php echo $row['disponibilidad']; ?>" >
					</div>
				</div>
